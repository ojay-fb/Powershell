...
# erstellt von Oliver Jonas, 20210319, Version 1.0
...
$NewUserTeilnehmerummer = $user.Teilnehmernummer
$NewUserName = ($user.Lastname+","+" "+$user.Firstname)
$NewUserDisplayName = ($user.Lastname+","+" "+$user.Firstname)
$NewUserSAMAccountName = ($user.LastnameAdjusted+$user.Teilnehmernummer)
$NewImportOU = "OU=M-VEFB1902-HSV,OU=M-VEFB,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
$ADServer = "2-sv-dc-tn-01.bfwtn.intern"
$NewStartPassword = "Start2021"
...
$NewUserHomeGroup = "M-VEFB1902-HSV_G"
$NewPosition = "Teilnehmer - M-VEFB1902"
$NewDepartment = "Bereich Steuern und Verwaltung"
