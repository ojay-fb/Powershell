...
$NewImportOU = "OU=M-FINK2402-HIT,OU=M-FINK,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
# $NewUserHomeGroup = "2-GG-M-FAAN2202-HIT"
$NewPosition = "Teilnehmer - M-FINK2402"
