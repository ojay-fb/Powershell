...
$NewImportOU = "OU=M-KAGH2302-HHW,OU=M-KAGH,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-KAGH2302-HHW"
$NewPosition = "Teilnehmer - M-KAGH2302"
