...
$NewImportOU = "OU=M-BFAP2518-ASS,OU=M-BFAP,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-BFAP2518-ASS"
$NewPosition = "Teilnehmer - M-BFAP2518"
