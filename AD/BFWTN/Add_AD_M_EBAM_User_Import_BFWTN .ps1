...
$NewImportOU = "OU=M-EBAM2501-ASS,OU=M-EBA,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-EBAM2501-ASS"
$NewPosition = "Teilnehmer - M-EBAM2501"
