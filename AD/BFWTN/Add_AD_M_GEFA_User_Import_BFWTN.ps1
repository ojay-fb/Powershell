...
$NewImportOU = "OU=M-GEFA2401-HBG,OU=M-GEFA,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-GEFA2401-HBG"
$NewPosition = "Teilnehmer - M-GEFA2401"
