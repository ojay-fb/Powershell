...
$NewImportOU = "OU=M-VEFB2501-HSV,OU=M-VEFB,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-VEFB2501-HSV"
$NewPosition = "Teilnehmer - M-VEFB2501"
