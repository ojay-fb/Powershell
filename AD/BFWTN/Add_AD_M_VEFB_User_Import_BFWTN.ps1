...
$NewImportOU = "OU=M-VEFB2402-HSV,OU=M-VEFB,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-VEFB2402-HSV"
$NewPosition = "Teilnehmer - M-VEFB2402"
