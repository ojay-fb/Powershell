...
$NewImportOU = "OU=M-RVL2407-RVI,OU=M-RVL,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-RVL2407-RVI"
$NewPosition = "Teilnehmer - M-RVL2407"
$NewDepartment = "Bereich Vorbereitung und Integration"
