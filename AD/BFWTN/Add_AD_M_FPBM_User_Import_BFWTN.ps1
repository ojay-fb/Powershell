...
$NewImportOU = "OU=M-FPBM2402-HBG,OU=M-FPBM,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-FPBM2402-HBG"
$NewPosition = "Teilnehmer - M-FPBM2402"
