...
$NewImportOU = "OU=B-VEOEV2401,OU=B-VEFB,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-VEOEV2401"
$NewPosition = "Teilnehmer - B-VEOEV2401"
