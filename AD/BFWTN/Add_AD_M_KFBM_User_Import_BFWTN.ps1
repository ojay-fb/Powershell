...
$NewImportOU = "OU=M-KFBM2501-HBG,OU=M-KFBM,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-KFBM2501-HBG"
$NewPosition = "Teilnehmer - M-KFBM2501"
