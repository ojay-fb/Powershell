...
$NewImportOU = "OU=M-RVT2404-BTZ,OU=M-RVT,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-RVT2404-BTZ"
$NewPosition = "Teilnehmer - M-RVT2404"
