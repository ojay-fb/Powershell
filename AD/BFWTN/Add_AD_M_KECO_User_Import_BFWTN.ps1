...
$NewImportOU = "OU=M-KECO2402-HHW,OU=M-KECO,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-KECO2402-HHW"
$NewPosition = "Teilnehmer - M-KECO2402"
$NewDepartment = "Bereich Kaufmännische Berufe"
