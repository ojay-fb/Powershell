...
$NewImportOU = "OU=B-EBAC2406-ASS,OU=B-REHA,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-EBAC2406-ASS"
$NewPosition = "Teilnehmer - B-EBAC2406"
