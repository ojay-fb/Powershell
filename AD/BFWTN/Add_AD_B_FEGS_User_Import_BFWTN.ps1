...
$NewImportOU = "OU=B-FEGS2301-HME,OU=B-EGS,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-FEGS2301-HME"
$NewPosition = "Teilnehmer - B-FEGS2301"
$NewDepartment = "Abteilung IQ, Ausbildungsbereich"
