...
$NewImportOU = "OU=B-VEFB2302-HSV,OU=B-VEFB,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-VEFB2302-HSV"
$NewPosition = "Teilnehmer - B-VEFB2302"
