...
$NewImportOU = "OU=B-BFAP2408-ASS,OU=B-REHA,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-BFAP2408-ASS"
$NewPosition = "Teilnehmer - B-BFAP2408"
