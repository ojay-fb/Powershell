...
$NewImportOU = "OU=M-MGDM2401-HIT,OU=M-MGDM,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
# $NewUserHomeGroup = "2-GG-M-MGDM2401-HIT"
$NewPosition = "Teilnehmer - M-MGDM2401"
$NewDepartment = "Bereich IT-Technik 4.0"
...
Add-ADPrincipalGroupMembership -Server $ADServer -Identity $NewUserSAMAccountName -MemberOf ("2-GG-PREVENT-LOGON-MA-PC")
