...
$NewImportOU = "OU=M-VEFK2402-HSV,OU=M-VEFK,OU=User_TN,OU=User_All,OU=2-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "2-GG-M-VEFK2402-HSV"
$NewPosition = "Teilnehmer - M-VEFK2402"
