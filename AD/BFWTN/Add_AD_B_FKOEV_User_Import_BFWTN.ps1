...
# erstellt von Oliver Jonas, 20220124, Version 1.0
...
$NewImportOU = "OU=B-FKOEV2301-IIQ,OU=B-FKOEV,OU=User_TN,OU=User_All,OU=1-BFWTN,DC=bfwtn,DC=intern"
...
$NewUserHomeGroup = "B-FKOEV2301-IIQ"
$NewPosition = "Teilnehmer - B-FKOEV2301"
$NewDepartment = "Bereich Steuern und Verwaltung"
$NewLocation = "Charlottenburg"
...
Add-ADPrincipalGroupMembership -Server $ADServer -Identity $NewUserSAMAccountName -MemberOf ($NewUserHomeGroup)
